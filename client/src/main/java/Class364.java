...
public final class Class364 implements Runnable {
	...
	public synchronized void method8373(@OriginalArg(1) Interface22 arg0) {
		...
		this.aLong286 = Static588.getCurrentTimeWithDrift();
	}
	...
	public void run() {
		while (!this.aBoolean732) {
			...
			synchronized (this) {
				try {
					...
					if (this.anInterface22_1 instanceof Class374) {
						...
						@Pc(25) long local25 = Static588.getCurrentTimeWithDrift();
			...
			@Pc(304) long local304 = Static588.getCurrentTimeWithDrift();
