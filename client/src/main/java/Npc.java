...
public final class Npc extends PathingEntity {
	...
	public Npc(@OriginalArg(0) int arg0) {
		super(arg0);
	}
		...
		for (@Pc(40) int local40 = 0; local40 < super.aModelArray3.length; local40++) {
			if (super.aModelArray3[local40] != null) {
				...
				if (Static504.aBoolean579) {
					local105 = super.aModelArray3[local40].method7483(arg1, arg0, local20, local89, this.aNpcType1.anInt6723, Static582.anInt8627);
				} else {
					local105 = super.aModelArray3[local40].method7486(arg1, arg0, local20, local89, this.aNpcType1.anInt6723);
				}
				if (local105) {
					local38 = true;
					break;
	...
	private boolean method9324(@OriginalArg(0) int arg0, @OriginalArg(2) Class19 arg1) {
		...
		@Pc(134) Model local134 = super.aModelArray3[0] = this.aNpcType1.method5993(Static34.aClass304_1, arg1, Static574.aBasTypeList2, local27, local111, super.anIntArray877, this.aClass386_1, local47, arg0, super.aClass152_Sub2_Sub1Array3);
		if (local134 == null) {
			return false;
		}
