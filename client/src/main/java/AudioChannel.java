...
public class AudioChannel {
	...
	private final PcmStream[] aClass2_Sub6Array5 = new PcmStream[8];
	...
	private final PcmStream[] aClass2_Sub6Array6 = new PcmStream[8];

	@OriginalMember(owner = "client!cd", name = "G", descriptor = "I")
	private int anInt4102 = 0;

	@OriginalMember(owner = "client!cd", name = "a", descriptor = "(ILclient!dea;)V")
	public final synchronized void method3582(@OriginalArg(1) PcmStream arg0) {
	...
	private void method3591(@OriginalArg(1) int arg0, @OriginalArg(2) PcmStream arg1) {
		...
		@Pc(12) PcmStream local12 = this.aClass2_Sub6Array5[local7];
		if (local12 == null) {
	...
	private void method3595(@OriginalArg(0) int[] arg0) {
		...
		if (this.aClass2_Sub6_6 != null && this.anInt4099 <= 0) {
			...
			label103: while (local49 != 0) {
				...
				for (@Pc(74) int local74 = local49 >>> local58 & 0x11111111; local74 != 0; local74 >>>= 0x4) {
					if ((local74 & 0x1) != 0) {
						...
						@Pc(97) PcmStream local97 = this.aClass2_Sub6Array6[local58];
						label97: while (true) {
							while (true) {
								if (local97 == null) {
									break label97;
								}
								@Pc(101) Sound local101 = local97.aClass2_Sub49_6;
								if (local101 == null || local101.anInt8817 <= local63) {
									...
									@Pc(148) PcmStream local148 = local97.method9133();
									if (local148 != null) {
									...
									@Pc(172) PcmStream local172 = local97.aClass2_Sub6_9;
			...
			for (local58 = 0; local58 < 8; local58++) {
				@Pc(218) PcmStream local218 = this.aClass2_Sub6Array6[local58];
				this.aClass2_Sub6Array6[local58] = this.aClass2_Sub6Array5[local58] = null;
				while (local218 != null) {
					@Pc(232) PcmStream local232 = local218.aClass2_Sub6_9;
