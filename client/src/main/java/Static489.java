	...
	public static void method6548() {
		...
		for (@Pc(282) int local282 = 0; local282 < Static319.aByteArrayArray16.length; local282++) {
			...
			if (local287 != null) {
				...
				local10 &= Static213.method3141(local287, local299, Static720.anInt10859, chunkSize, Static501.anInt7568);
			}
		...
		if (Static163.aClass19_17.method7990() && Static400.aClass2_Sub34_28.aPreference_Sub26_1.method7463() == 2) {
			for (chunkSize = 0; chunkSize < Static319.aByteArrayArray16.length; chunkSize++) {
				if (Static421.aByteArrayArray19[chunkSize] != null || Static177.aByteArrayArray5[chunkSize] != null) {
					local430 = true;
					break;
				}
			}
		}
		if (Static400.aClass2_Sub34_28.aPreference_Sub16_1.method5507() == 1) {
			chunkSize = Static571.anIntArray682[Static537.anInt8170] * ClientConfig.RENDER_DISTANCE_MULTIPLIER;
		} else {
			chunkSize = Static506.anIntArray728[Static537.anInt8170] * ClientConfig.RENDER_DISTANCE_MULTIPLIER;
		}
		if (Static163.aClass19_17.method7968()) {
			chunkSize++;
		}
		Static21.method8043(Static163.aClass19_17, Static455.availableRenderCores, Static720.anInt10859, Static501.anInt7568, chunkSize, local430, Static163.aClass19_17.method7955() > 0);
		...
		Static439.anInt6674 = Static400.aClass2_Sub34_28.aPreference_Sub12_1.method4364();
		Static428.aBoolean487 = Static369.anInt4265 >= 96;
		Static50.aBoolean566 = Static400.aClass2_Sub34_28.aPreference_Sub26_1.method7463() == 2;
		Static305.aBoolean371 = Static400.aClass2_Sub34_28.aPreference_Sub24_1.method7082() == 1;
		Static478.anInt7198 = Static400.aClass2_Sub34_28.aPreference_Sub19_2.method5960() == 1 ? -1 : Static164.anInt2808;
		Static718.aBoolean822 = Static400.aClass2_Sub34_28.aPreference_Sub23_1.method7054() == 1;
		Static196.aBoolean262 = Static400.aClass2_Sub34_28.aPreference_Sub30_1.method8356() == 1;
		...
		if (Static400.aClass2_Sub34_28.aPreference_Sub19_2.method5960() == 0) {
		...
		if (Static283.gameState == 4) {
			Static81.method1586(3);
		} else if (Static283.gameState == 8) {
			Static81.method1586(7);
		} else if (Static283.gameState == 10) {
			Static81.method1586(9);
		} else {
			Static81.method1586(11);
			if (Connection.gameConnection.aClass348_1 != null) {
				local920 = OutboundPacket.create(Static161.aClientProt29, Connection.gameConnection.random);
				Connection.gameConnection.queue(local920);
			}
		}
