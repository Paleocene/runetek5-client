...
public final class Player extends PathingEntity {
	...
	public Player(@OriginalArg(0) int arg0) {
		super(arg0);
	}
	...
	public void method9289(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1) {
		if (this.aPlayerAppearance1 == null || !super.aBoolean820 && !this.method1421(0, arg0)) {
			return;
		}
	...
	public void method1413(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2) {
		this.method9313(Static324.getFps() * Static65.aClass3_1.anInt87, arg2, arg1, arg0);
	}

	@OriginalMember(owner = "client!ca", name = "a", descriptor = "(BIIILclient!ka;Lclient!tt;Lclient!ha;I)V")
	private void method1414(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Model arg4, @OriginalArg(5) Class73 arg5, @OriginalArg(6) Class19 arg6, @OriginalArg(7) int arg7) {
		if (arg0 != -74) {
		...
		if (local65 != null) {
			arg6.C(false);
			local65.method7473(arg5, (ParticleNode_Sub6) null, 0);
			arg6.C(true);
		}
	}
	...
	public boolean method9279(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class19 arg3) {
		if (this.aPlayerAppearance1 == null || !this.method1421(131072, arg3)) {
			return false;
		}
	...
	private void method1416(@OriginalArg(0) Model arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Class19 arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) Class73 arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7) {
		...
		if (local65 != null) {
			arg2.C(false);
			local65.method7484(arg5, (ParticleNode_Sub6) null, arg6, 0);
			arg2.C(true);
		}
	}
	...
	public boolean method1417() {
		return this.aPlayerAppearance1 != null;
	}
	...
	public int method9302(@OriginalArg(0) byte arg0) {
		if (this.aPlayerAppearance1 == null || this.aPlayerAppearance1.anInt5012 == -1) {
			if (arg0 < 43) {
				this.anInt1460 = 1;
			}
			return super.method9302((byte) 76);
		} else {
			return Static690.aNpcTypeList2.method7092(this.aPlayerAppearance1.anInt5012).anInt6713;
		}
	}
	...
	public ParticleNode_Sub7 method9276(@OriginalArg(1) Class19 arg0) {
		if (this.aPlayerAppearance1 == null || !this.method1421(2048, arg0)) {
			return null;
		}
	...
	public void method1420(@OriginalArg(0) Packet arg0) {
			...
			if (Static125.aClass388_1.anIntArray821[local151] != 1) {
				...
				if (local165 == 0) {
					...
					if (local191 >= 32768) {
						...
						local149[local151] = ObjTypeList.objTypes.method2486(local191);
		...
		if (this.aPlayerAppearance1 == null) {
			this.aPlayerAppearance1 = new PlayerAppearance();
		}
		local240 = this.aPlayerAppearance1.anInt5012;
	...
	private boolean method1421(@OriginalArg(0) int arg0, @OriginalArg(2) Class19 arg1) {
		...
		@Pc(152) Model local152 = super.aModelArray3[0] = this.aPlayerAppearance1.method4546(ObjTypeList.objTypes, local33, Static574.aBasTypeList2, Static25.aSeqTypeList1, arg0, super.anIntArray877, Static125.aClass388_1, Static68.aIdkTypeList3, arg1, Static690.aNpcTypeList2, super.aClass152_Sub2_Sub1Array3, local95, local58, Static34.aClass304_1);
