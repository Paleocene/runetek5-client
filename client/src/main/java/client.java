...
public final class client extends GameShell {
	...
	public static int method3448() {
		...
		if (Static198.aClass140_1 == Static473.aClass140_22) {
			...
			@Pc(77) long local77 = Static588.getCurrentTimeWithDrift();
		...
		if (Static473.aClass140_22 == Static198.aClass140_18) {
			...
			for (local74 = 0; local74 < Static453.aComponentArrayArray2[Static65.aClass3_1.anInt88].length; local74++) {
				...
				if (local1315.anInt3820 == 5 && local1315.anInt3810 != -1 && !sprites.isFileReady(local1315.anInt3810, 0)) {
					local184 = false;
				}
			}
			if (!local184) {
	...
	public synchronized void method1641() {
		if (Static166.anApplet1 != null && Static434.aCanvas7 == null && !Static446.aSignlink6.aBoolean779) {
			try {
		...
		try {
			...
			if (Static92.anInt1874 == 1) {
				if (Static514.aPrivilegedRequest6.state == 2) {
					if (Static514.aPrivilegedRequest6.anObject13 != null) {
						Static376.aString62 = (String) Static514.aPrivilegedRequest6.anObject13;
					}
			...
			if (Static92.anInt1874 == 2) {
				Static672.aClientStream2 = new ClientStream((Socket) Static514.aPrivilegedRequest6.anObject13, Static446.aSignlink6, 25000);
				...
				Static92.anInt1874++;
				Static678.aLong310 = Static588.getCurrentTimeWithDrift();
			}
			if (Static92.anInt1874 == 3) {
				if (Static181.method2778(Static283.gameState) || Static672.aClientStream2.method5828() > 0) {
					...
					Static92.anInt1874++;
				} else if (Static588.getCurrentTimeWithDrift() - Static678.aLong310 > 30000L) {
	...
	private void method1658() {
		...
		if ((Static283.gameState == 3 || Static283.gameState == 9 || Static283.gameState == 7) && (!Static242.method3500() || Static283.gameState == 9 && Static169.anInt2855 == 42) && Static6.anInt95 == 0) {
								...
								while (true) {
									do {
										...
										if (local453 == null) {
											...
											if (Static624.aBoolean727 && Static588.getCurrentTimeWithDrift() - 60000L > Static98.aLong71) {
												Static266.method6777();
											}
											for (@Pc(672) SecondaryParticleNode_Sub1 local672 = (SecondaryParticleNode_Sub1) Static168.aParticleLinkedList5.method2790(); local672 != null; local672 = (SecondaryParticleNode_Sub1) Static168.aParticleLinkedList5.method2785()) {
												if ((long) local672.anInt6433 < Static588.getCurrentTimeWithDrift() / 1000L - 5L) {
	...
	private void method1666() {
		...
		if (Static475.method6445(Static283.gameState)) {
			if (Static297.aLong153 != 0L && Static588.getCurrentTimeWithDrift() > Static297.aLong153) {
		...
		if (Static316.aFrame8 == null) {
			...
			if (Static52.anInt1059 != local110 || local114 != Static54.anInt1084 || Static284.aBoolean355) {
				...
				Static297.aLong153 = Static588.getCurrentTimeWithDrift() + 500L;
		...
		if (Static400.aClass2_Sub34_28.aPreference_Sub10_1.method3519() == 1 && Static283.gameState == 3 && Static377.anInt5930 != -1) {
	...
	private void method1668() {
		...
		if (Static163.aClass19_17 != null) {
			Static163.aClass19_17.method7977((int) Static588.getCurrentTimeWithDrift());
		}
