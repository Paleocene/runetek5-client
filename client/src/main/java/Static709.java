...
public final class Static709 {
	...
	public static void method9252() {
		if (Static655.aClass140Array1 == null) {
			...
			Static72.aLong52 = Static588.getCurrentTimeWithDrift();
		}
	...
	public static void method9254() {
		...
		if (Static211.aClass2_Sub12_3 == null) {
			if (Static675.aLong307 <= Static588.getCurrentTimeWithDrift()) {
			...
			Static675.aLong307 = Static588.getCurrentTimeWithDrift() + 30000L;
		}
		...
		if (local166 != null || Static56.aLong38 < Static588.getCurrentTimeWithDrift() - 2000L) {
			local179 = null;
			local181 = 0;
		...
		while (true) {
			...
			do {
				local2006 = (Linkable_Sub42) Static618.aLinkedList68.removeHead();
				if (local2006 == null) {
					while (true) {
						do {
							local2006 = (Linkable_Sub42) Static59.aLinkedList33.removeHead();
							if (local2006 == null) {
								while (true) {
									do {
										local2006 = (Linkable_Sub42) Static521.aLinkedList44.removeHead();
										if (local2006 == null) {
											...
											if (Static608.anInt9290 > 0 && Static334.aKeyboard1.method8479(82) && Static334.aKeyboard1.method8479(81) && Static611.anInt9341 != 0) {
											...
											if (Static624.aBoolean727 && Static98.aLong71 < Static588.getCurrentTimeWithDrift() - 60000L) {
											...
											for (@Pc(2281) SecondaryParticleNode_Sub1 local2281 = (SecondaryParticleNode_Sub1) Static168.aParticleLinkedList5.method2790(); local2281 != null; local2281 = (SecondaryParticleNode_Sub1) Static168.aParticleLinkedList5.method2785()) {
												if (Static588.getCurrentTimeWithDrift() / 1000L - 5L > (long) local2281.anInt6433) {
