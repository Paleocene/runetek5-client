...
public final class Mouse_Sub2 extends Mouse implements MouseListener, MouseMotionListener {
	...
	public Mouse_Sub2(@OriginalArg(0) Component arg0, @OriginalArg(1) boolean arg1) {
	...
	private void method8855(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		...
		local15.aLong181 = Static588.getCurrentTimeWithDrift();
